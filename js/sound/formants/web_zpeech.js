/*
*
* This is a browserified and simplified version of a node.js software called zpeech
* See https://github.com/gre/zpeech 
*
* The code contains the three externals (node modules) 
* Go to line 19614 to see the main script
*
*
*/
...
function formantsToVowels (formants, f1Params, f2Params) {
  var formantsFreq = _.map(formants, "freq");
  ...
  // changed pluck to map
  var max = _.max(_.map(distances, 1));
...
/*
*
*  This is version of Zpeech without the GUI stuff 
*  See https://github.com/gre/zpeech 
*
*/
...
//var Spectrum = require("js/sound/formants/src/spectrum");
...
},{"./src/extractFormants":6,"./src/formantsToVowels":7,"./src/getMicrophone":8,"audiocontext":3,"lodash":4}]},{},[9]);
